const List<Map<String, dynamic>> kEmulatorDefinitions = [
  {
    ...
    'platform_slugs': [
      ...
      'gamegear', 'sms', 'mastersystem', 'atari2600', 'atari7800', 'lynx', 'neogeo', 'neo-geo', 'neogeoaes', 'neogeomvs', 'neo-geo-aes', 'neo-geo-mvs', 'mvs', 'aes', 'arcade', 'mame',
  ...
  },
  {
    ...
    'github_asset_required_windows': ['windows-x64'],
    'github_asset_required_macos': ['macos-universal', '.zip'],
    'github_asset_required_linux': ['linux-x64', '.AppImage'],
    'github_asset_excluded': ['source', 'dSYMs', 'PDBs', 'clang-cl', 'arm64'],
    'windows_executable': 'ares.exe',
    'linux_executable': 'ares.AppImage',
    'macos_executable': 'ares.app/Contents/MacOS/ares',
    'platform_slugs': [
      'gba', 'gb', 'gbc',
      'snes', 'sfc',
      'n64',
      'genesis', 'megadrive', 'md', 'segacd',
