const List<Map<String, dynamic>> kEmulatorDefinitions = [
  ...
  },
  {
    ...
    'name': 'Ryujinx (Switch)',
    'type': 'gitea',
    'gitea_base_url': 'https://git.ryujinx.app',
    'gitea_repo': 'Ryubing/Canary',
    'gitea_asset_required_windows': ['win_x64', '.zip'],
    'gitea_asset_required_macos': ['macos_universal', '.tar.gz'],
    'gitea_asset_required_linux': ['x64', '.AppImage'],
    'gitea_asset_excluded': ['arm64'],
