const List<Map<String, dynamic>> kEmulatorDefinitions = [
  ...
  },
  {
    ...
    'github_asset_required_macos': ['macos', 'arm64', '.zip'],
  ...
  },
  {
    ...
    'github_asset_required_macos': ['macos', 'universal', 'release'],
  ...
  },
  {
    ...
    'github_asset_required_macos': ['macOS', 'arm64', '.app.zip'],
    'github_asset_excluded': ['debug', 'symbols'],
    'github_asset_excluded_windows': ['linux', 'macos'],
    'github_asset_excluded_macos': ['windows', 'linux'],
  ...
  },
  {
    ...
    'github_asset_required_macos': ['osx', '64bit', '.tar.xz'],
